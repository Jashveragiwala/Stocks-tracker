// src/pages/PastInvestments.js
import React from 'react';
import { Container, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper } from '@mui/material';
import { styled } from '@mui/material/styles';

const data = [
  { id: 1, name: 'Stock A', buyingPrice: 100, sellingPrice: 120, quantity: 50 },
  { id: 2, name: 'Stock B', buyingPrice: 200, sellingPrice: 180, quantity: 30 },
];

const calculateCommission = (price) => price * 0.0066 * 2;
const calculateProfitPerShare = (buyingPrice, sellingPrice) => sellingPrice - buyingPrice - calculateCommission(buyingPrice);
...
const PastInvestments = () => {
  return (
    <Container>
      <Typography variant="h4" gutterBottom>Past Investments</Typography>
        ...
        <Table>
          ...
          <TableBody>
            {data.map((row, index) => {
              ...
              const profitPerShare = calculateProfitPerShare(row.buyingPrice, row.sellingPrice);
